...
const About = () => {
    ...
    return (
        <>
            <div
                className="min-h-screen w-full bg-gray-900  text-white flex flex-col items-center px-4 md:px-10 py-10"
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl px-4">
                    {[
                        ...
                        <div
                            key={i}
                            className="bg-white/80 p-6 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300"
                        >
